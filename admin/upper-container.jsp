			...
			<nav class="ttr-sidebar-navi">
				<ul>
                    ...
                    <li>
						...
						<ul>
							<li><a href="./student_save.jsp">Add Student</a></li>
							<li><a href="./students_view.jsp?msg=Welcome to View">View Details</a></li>
							<li><a href="./exam.jsp">Schedule Exam</a></li>
							<li><a href="./student_result.jsp?msg=Welcome To Exam Management">Manage Result</a></li>
						</ul>
		            </li>
					<li>
